...
public class Mapx {
    ...
    /**
     * This reads the maps file and stores the country, continent and border details in their variables
     * This is used by createGameGraph().
     * The variables generated by this method  are used throughout the game.
     * @param mapFile
    ...
    /**
     * creates gameGraph of the map file provided
     * gameGraph returned by this method is the most important variable in the whole game
     * gameGraph is a Graph that holds an ArrayList of countries
     * @param mapFile
     * @return
     */
    ...
    /**
     * This method removes a neighbour from a country that exists in the gameGraph variable
    ...
    /**
     * This method removes a country from the gameGraph list, and makes the necessary changes to the list
